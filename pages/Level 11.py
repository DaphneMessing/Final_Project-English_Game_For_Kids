...
sentences = {
    "Spongebob": [
        "The residents of Bikini Bottom enjoy underwater sports and festive celebrations.",
        "SpongeBob’s laughter is so loud it can be heard across the entire city.",
        "Plankton never gives up on his dream of stealing the secret formula.",
        "Patrick loves to make silly plans that often lead to unexpected adventures.",
        "Sandy is always inventing new gadgets in her laboratory."
    ],
    "PJ Masks": [
        "The heroes sneak quietly through the shadows to catch the villain by surprise.",
        "The Owl-Glider swoops through the sky, scanning the city for troublemakers.",
        "At night, the team uses their gadgets and vehicles to protect the city.",
        "With great courage, the team defends their home from every new threat.",
        "Teamwork and bravery are what keep the city safe from mischief-makers."
    ],
    "Winx Club": [
        "The fairies practice their spells daily to keep their magic skills sharp.",
        "The enchanted forest is filled with mysterious creatures and hidden dangers.",
        "The evil witches constantly plot to steal the Winx Club's magical powers.",
        "The girls must navigate a maze of traps to reach their destination.",
        "With their combined powers, the fairies overcome every challenge together."
    ],
    "Spidey And His Amazing Friends": [
        "The team moves swiftly through the city, always ready for action.",
        "With agility and skill, they avoid the traps set by their enemies.",
        "The heroes swing through the air, looking out for any signs of danger.",
        "Together, they patrol the streets, ensuring the city is safe and secure.",
        "They always trust each other to do the right thing in every situation."
    ]
}
