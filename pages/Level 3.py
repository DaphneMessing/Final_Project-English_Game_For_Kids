...
def main():
    ...
    # Display "Return to Home Page" button as a red arrow, except on the final page
    if not st.session_state.final_congratulations:
        st.markdown(
            """
    ...
    if sentence:
        ...
        audio_file = os.path.join(
            os.path.dirname(__file__), '..', 'audio_level3', f"{show.replace(' ', '')}_{st.session_state.sentence_index}.mp3"
        )
        ...
        # Input box for the user's answer with dynamic key
